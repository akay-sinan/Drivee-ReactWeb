      ...
      <SimpleBar className="h-100" ref={ref}>
        <div id="sidebar-menu">
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li className="menu-title">{props.t("Lists")}</li>
            <li>
              <Link to="/araclar" >
            ...
            <li>
              <Link to="/calisanlar" >
                ...
                <span>{props.t("Workes")}</span>
              </Link>
            </li>
            
            <li>
              <Link to="/departmanlar" >
                <i className="bx bx-buildings"></i>
                <span>{props.t("Deparments")}</span>
              </Link>
            </li>
            <li className="menu-title">{props.t("Pages")}</li>
            
            <li>
              <Link to="/arac-gecmisi" >
                <i className="bx bx-history"></i>
                <span>{props.t("CarHistory")}</span>
              </Link>
            </li>
            <li>
              <Link to="/canli-harita" >
                
                <i className="bx bx-map-pin"></i>
                <span className="badge rounded-pill bg-success float-end">
                  Canlı
                </span>
                <span>{props.t("LiveMap")}</span>
              </Link>
            </li>
            <li>
              <Link to="/cagri-merkezi" >
                <i className="bx bx-desktop"></i>
                <span>Çağrı Merkezi İzleme</span>
              </Link>
            </li>
            <li>
              <Link to="/cagri-gönderme" >
                <i className="bx bx-phone-call"></i>
                <span>Çağrı Gönderme</span>
              </Link>
            </li>
            <li>
              ...
              <li>
                ...
                <li>
                  <Link to="/ecommerce-product-detail/1">
                    Güvenli Sürüş Dinamikleri
                  </Link>
                </li>
                <li>
                  <Link to="/ecommerce-products">Günlük Km</Link>
                </li>
                <li>
                  <Link to="/ecommerce-product-detail/1">
                    Sürücü Puanı Raporu
                ...
                <li>
                  <Link to="/ecommerce-product-detail/1">
                    Sinyal Göndermeyen Araçlar Raporu
                  </Link>
                </li>
              </ul>
            </li>
